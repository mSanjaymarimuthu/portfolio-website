...
https://msanjaymarimuthu.github.io/portfolio-website/
...
```bash
sudo git clone https://github.com/mSanjaymarimuthu/portfolio-website.git
```

Windows:

```bash
git clone https://github.com/mSanjaymarimuthu/portfolio-website.git
```
